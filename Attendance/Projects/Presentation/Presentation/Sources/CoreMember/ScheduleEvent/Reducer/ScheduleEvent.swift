    ...
    Reduce { state, action in
      ...
      case .inner(let InnerAction):
        ...
        case let .tapEditEvent(
          ...
          let convertDateString = String.stringToTimeAndDate(convertDate)
          ...
          let convertEndDateString = String.stringToTimeAndDate(convertEndDate)
